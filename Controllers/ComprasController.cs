...
namespace RefrescosDelValle.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public async Task<IActionResult> Proveedores(string? searchString, bool? activo)
        {
        ...
        // GET: Compras/Proveedores/Details/5
        public async Task<IActionResult> ProveedorDetails(int id)
        {
        ...
        // GET: Compras/Proveedores/Create
        public IActionResult CrearProveedor()
        {
            return View();
        }
        
        // POST: Compras/Proveedores/Create
        [HttpPost]
        ...
        // GET: Compras/Proveedores/Edit/5
        ...
        // POST: Compras/Proveedores/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditarProveedor(int id, Proveedore proveedor)
        {
        ...
        // POST: Compras/Proveedores/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
